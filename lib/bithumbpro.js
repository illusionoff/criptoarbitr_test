...
const TRACK_ELEMENT_ORDERBOOK = 9;
...
function wsStartBith(cmd, args, initialGate, writableFiles) {
  ...
  ws.onmessage = function (message) {
    ...
    if (initialBith.messageObj.code === "00007") {
      console.log('00007***************************************************');
      initialBith.timeServer = new Date().getTime();
      console.log('testCountRestApi=', testCountRestApi);
      ...
      if (Number(initialBith.messageObj.data.ver) === initialBith.ver + 1) {
        ...
        // }
        console.log('initialBith.allOrderbookBay[9]=', initialBith.allOrderbookBay[9]);
        ...
        //   // console.log(allOrderbookSell[i]);
        // }
        console.log('initialBith.allOrderbookSell[9]=', initialBith.allOrderbookSell[9]);
        ...
        // //   initialBith.bay = Number(trackElementOrderbookBay0);
        // //   initialBith.bayQuantity = Number(trackElementOrderbookBay1);
        ...
        if (initialGate.globalFlag && initialBith.globalFlag) {
          ...
          if (changeTradeArr(initialBith)) {
            const paramsGoTrade = {
              ...
              timeServer: initialBith.timeServer,

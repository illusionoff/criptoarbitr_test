...
function TestWritable(testWriteableStream_1, testWriteableStream_2, testFlag, testCount, testCountAll) {
  ...
  console.log('testWriteableStream_1.writableLength', testWriteableStream_1.writableLength);
  console.log('testWriteableStream_1:', testWriteableStream_1);
  ...
  if (testFlag.number === 1) {
    if (!testWriteableStream_2._writableState.finished) {
      if (testWriteableStream_2._writableState.length === 0) {
        ...
        console.log(`testWriteableStream_2.destroy() ----------------------------------------------------------------------------------------------------`);
      }
    }
  }
  ...
  if (testFlag.number === 1) {
    ...
    testWriteableStream_1.write(`writeableStream_${testCountAll.number}\r\n`);
  }
  if (testFlag.number === 2) {
    console.log('writeableStream_2');
    console.log('testWriteableStream_2._writableState:', testWriteableStream_2._writableState);

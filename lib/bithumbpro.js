...
function wsStartBith(cmd, args, initialGate, writableFiles) {
  ...
  ws.onmessage = function (message) {
    ...
    let resultCorrectTimeServer = correctTimeServer(ws, initialBith.messageObj, true, MINTIME_ONE_PING, MINTIME_ALL_PING);
    ...
    if (initialBith.messageObj.code && initialBith.messageObj.code === '00001') {
      console.log('initialBith.messageObj.code=', initialBith.messageObj.code);
      // process.exit();
    }

...
function wsStartBith(cmd, args, initialGate) {
  ...
  ws.onmessage = function (message) {
    ...
    if (initialBith.messageObj.code === "00007") {
      ...
      initialBith.priceAndComissionsBay = initialBith.sell + initialBith.sell * initialBith.takerComissions;
      initialBith.priceAndComissionsSell = initialBith.buy - initialBith.buy * initialBith.makerComissions;

...
const { goTrade, changeTradeArr, timeStopTestClosure, consoleLogGroup, timerClosure, funStartPing, funEndPing, funStartReconnect, coinConfigBith } = require('../functions/functions');

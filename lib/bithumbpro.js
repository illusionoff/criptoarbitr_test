...
let initialBith = {
  ...
  allOrderbookSell: [],
  ver: 0,
  orderbookFirstPreviousBay: [],
  orderbookFirstPreviousSell: [],
...
function wsStartBith(cmd, args, initialGate, writableFiles) {
  ...
  ws.onmessage = function (message) {
    ...
    if (initialBith.messageObj.code === "00006") {
      ...
      allOrderbookBay = initialBith.messageObj.data.b;
      allOrderbookSell = initialBith.messageObj.data.s;
      ...
      console.log('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++');//для отладки себе включить
    ...
    if (initialBith.messageObj.code === "00007") {
      if (Number(initialBith.messageObj.data.ver) === initialBith.ver + 1) {
        ...
        changeFirstOrderbook(orderbookFirstPreviousBay, allOrderbookBay)
        ...
        //     console.log(allOrderbookSell[i]);
        //   }
        //   console.log('orderbookFirstPreviousBay[0]=', orderbookFirstPreviousBay[0]);
        //   console.log('orderbookFirstPreviousSell[0]=', orderbookFirstPreviousSell[0]);
        //   console.log('Data first element ORDERBOOK changes Bay');
        //   process.exit();
        // }
      ...
      } else { ws.reconnect(1006, 'initialBith.ver not matches'); }
      console.log('initialBith.messageObj:', initialBith.messageObj);
      console.log('---------------------------------------');

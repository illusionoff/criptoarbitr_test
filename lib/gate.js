...
const WS = require('ws');
const { goTrade, changeTradeArr, timeStopTestClosure, consoleLogGroup, reinitGate, maxPercentCupClosure, timerClosure, funStartPing, funEndPing, funStartReconnect } = require('../functions/functions');

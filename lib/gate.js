...
const WS = require('ws');
const { goTrade, changeTradeArr, reconnectTimeMessageClosure, timeStopTestClosure, consoleLogGroup, reinitGate, maxPercentCupClosure, timerClosure, funStartReconnect } = require('../functions/functions');

...
const WS = require('ws');
const { goTrade, changeTradeArr, correctTimeServerClosure } = require('../functions/functions');
...
function wsGetGate(time, channel, event, payload, initialBith, writableFiles) {
  ...
  // let onceVar = once(testOnce());
  // console.log('onceVar1=', onceVar);
  // let cb = testOnce.once();
  // console.log('once(testOnce()1=', cb());
  // console.log('once(testOnce()2=', once(testOnce()));
  // testOnce = once(testOnce());
  ...
  ws.onmessage = function (evt) {
    ...
    // testOnce.once();
    // onceVar = once(testOnce())
    // onceVar.once(onceVar);
    // testOnce;
    // console.log('once(testOnce)=', onceVar());
    ...
    let typeofNumber = typeof resultCorrectTimeServer === "number";
    console.log('typeofNumber=', typeofNumber);

...
function wsGetGate(id, method, params, initialBith, writeableStream, counts) {
  ...
  ws.onmessage = function (evt) {
    ...
    if (messageGateObj.params) {
      ...
      // TEST
      messageGateObj.params[1].asks = [['0.71873', '0']]; //// TEST
      ...
      // TEST
      console.log('messageGateObj.params[1].asks:', messageGateObj.params[1].asks);
      console.log('messageGateObj.params[1].asks.length:', messageGateObj.params[1].asks.length);
      // TEST
      messageGateObj.params[1].bids = [['0.71859', '1251.54']]; //// TEST
      ...
      if (messageGateObj.params[1].asks && (messageGateObj.params[1].asks.length != 0) && (messageGateObj.params[1].bids.length != 0) && messageGateObj.params[1].bids) initialGate.globalFlag = true;

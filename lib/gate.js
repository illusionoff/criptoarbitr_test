  ...
  ws.onmessage = function (evt) {
    ...
    if (initialGate.messageObj.params) {
      ...
      if (initialGate.messageObj.params[0] === true) {
        allOrderbookBay = initialGate.messageObj.params[1].bids;
        allOrderbookSell = initialGate.messageObj.params[1].asks;

      }
      // console.log('allOrderbookBay=GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG', allOrderbookBay);

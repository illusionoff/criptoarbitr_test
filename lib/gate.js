...
const WS = require('ws');
const { goTrade, changeTradeArr, reconnectTimeMessageClosure, closureTimeStopTest, consoleLogGroup, reinitGate, maxPercentCupClosure } = require('../functions/functions');

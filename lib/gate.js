...
const MINTIME_ONE_PING = 3000;
const MINTIME_ALL_PING = 20000;
...
function wsGetGate(time, channel, event, payload, initialBith, writableFiles) {
  ...
  ws.onmessage = function (evt) {
    ...
    let resultCorrectTimeServer = correctTimeServer(ws, initialGate.messageObj, false, MINTIME_ONE_PING, MINTIME_ALL_PING);

...
function wsGetGate(time, channel, event, payload, initialBith, writableFiles) {
  ...
  ws.onmessage = function (evt) {
    ...
    if (initialGate.messageObj.event == "update" && initialGate.messageObj.result.bids) {
      ...
      console.log('initialGate.js initialGate.orderbookFirstPreviousBay=', initialGate.orderbookFirstPreviousBay);
      console.log('initialGate.js initialGate.bay=', initialGate.bay);
      console.log('It`sGate');
